    ...
    <form className="mt-8 space-y-6">
                          ...
                          <div>
                              <p className="text-center p-2 text-xs font-bold">OR</p>
                                <button type="button" className="group relative flex w-full justify-center rounded-md border border-transparent bg-slate-300 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                  <FcGoogle size={24}/>
                                </button>
                            </div>
    </form>
